...
import javax.swing.*;
public class LoginSector implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		int msg = rand.nextInt(999999);
		try {
		Email email = new Email("vijay.warriar4588@gmail.com","vijay*710");
		email.setFrom("vijay.warriar4588@gmail.com", "Election Commision of India");
		email.setSubject("One Time password(OTP) for Voter ID");
		email.setContent("Your OTP is "+msg, "text/html");
		email.addRecipient("suryaedu71@gmail.com");
		email.send();
